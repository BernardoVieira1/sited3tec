        ...
        <tbody>
          <?php
            ...
            while($user = mysqli_fetch_assoc($resultado)){
              ...
              echo "<td class = 'mags'><a href="."editar.php?id=".$user['id']."><button><img src='./arquivos/editar.svg' açt='editar'></button></a></td>";
              echo "<td class = 'mags'><a href="."deletar.php?id=".$user['id']."><button><img src='./arquivos/excluir.svg' açt='deletar'></button></a></td>";
              echo"</tr>";
            }
          ?> 
        </tbody>
